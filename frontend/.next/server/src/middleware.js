...
function utils_findBestMatch(requestedLocales, supportedLocales, threshold) {
    if (threshold === void 0) {
 ...
 */ function BestFitMatcher_BestFitMatcher(availableLocales, requestedLocales, getDefaultLocale) {
    var foundLocale;
    var extension;
 ...
 * @param requestedLocales
 * @param getDefaultLocale
 */ function LookupMatcher_LookupMatcher(availableLocales, requestedLocales, getDefaultLocale) {
    var result = {
        locale: ""
    };
 ...
 * @param extension
 * @param key
 */ function UnicodeExtensionValue_UnicodeExtensionValue(extension, key) {
 ...
 */ function ResolveLocale_ResolveLocale(availableLocales, requestedLocales, options, relevantExtensionKeys, localeData, getDefaultLocale) {
