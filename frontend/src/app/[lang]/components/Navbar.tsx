...
export default function Navbar({
  ...
  return (
    <div className="absolute top-0 right-0 left-0 p-4 text-gray-100">
      <div className="container flex justify-between h-16 mx-auto gap-2">
        ...
        >
          ...
          {/* Overlay */}
          <Dialog.Panel className="fixed inset-y-0 rtl:left-0 ltr:right-0 z-50 w-full overflow-y-auto bg-primary px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-inset sm:ring-white/10">
