...
export default function Slider<T>({ data, renderItem }: Slider<T>) {
  return (
    // <SlickSlider
    //   dots={true}
    //   infinite={true}
    ...
    //               <img src="https://mdbootstrap.com/img/new/textures/small/141.jpg" className="block w-full" alt="..." />
    ...
    //               <img src="https://mdbootstrap.com/img/new/textures/small/142.jpg" className="block w-full" alt="..." />
    //               <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
    ...
    //                 className="relative float-left -mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
    //                 data-te-carousel-item style={{ backfaceVisibility: 'hidden' }}>
    //               <img src="https://mdbootstrap.com/img/new/textures/small/143.jpg" className="block w-full" alt="..." />
    //               <div className="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
